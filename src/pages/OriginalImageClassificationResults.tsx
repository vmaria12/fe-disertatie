...
const OriginalImageClassificationResults = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://127.0.0.1:8000/api/reports/classification-report');
                if (!response.ok) {
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    <div className="p-6 border-b border-slate-200">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h1 className="text-2xl font-bold text-slate-900">Rezultate Clasificare - Imagine Originală</h1>
                        </div>
                        <p className="text-slate-600 ml-14">
                            Vizualizarea predicțiilor pentru fiecare clasă reală.
                        </p>
                    </div>
...
export default OriginalImageClassificationResults;
